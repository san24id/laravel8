...
<div class="row">
    <div class="col-lg-12 margin-tb">
        ...
        <div class="pull-left">
            ...
            <h2>Add Permohonan Informasi Publik</h2>
        </div>
    </div>
</div>
...
<form action="{{ route('layanans.storePIP') }}" method="POST">
    @csrf
    <input type="hidden" name="id_layanan" class="form-control" value="Permohonan Informasi Publik">
    <div class="row">
        <div class="box">
            <div class="box-header with-border">
                ...
                <table width="100%">
                    <tbody>
                        <tr>
                            ...
                            <td></td>
                            <td><td><strong>Informasi Yang Diminta:</strong></td>
                        </tr>
                        <tr>
                            <td><input type="text" name="telephone" class="form-control" placeholder="telephone"></td>
                            <td></td>
                            <td></td>
                            <td><textarea type="text" name="informasi" class="form-control" placeholder="Informasi Yang Diminta"></textarea></td>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" style="height:150px" name="tujuan" placeholder="Tujuan Permohonan Informasi"></textarea>
                    </div>
                </div>
            </div>
        </div>
